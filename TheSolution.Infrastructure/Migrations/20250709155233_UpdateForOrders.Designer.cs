...
namespace TheSolution.Infrastructure.Migrations
{
    ...
    [Migration("20250709155233_UpdateForOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheSolution.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TheSolution.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TheSolution.Domain.Entities.Order", b =>
                {
                    b.HasOne("TheSolution.Domain.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
